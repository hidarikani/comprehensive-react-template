- [Comprehensive React Template](#comprehensive-react-template)
  - [1. Installation](#1-installation)
- [Reasoning Behind Technology Choices](#reasoning-behind-technology-choices)
  - [2. Integrated Development Environment (IDE)](#2-integrated-development-environment-ide)
  ...
  - [11. TODO: Fetching Data](#11-todo-fetching-data)
  - [12. TODO: Routing](#12-todo-routing)
  - [13. Graphical User Interface](#13-graphical-user-interface)
...
[degit](https://github.com/Rich-Harris/degit) which can copy a git repository
...
## 2. <a name='IntegratedDevelopmentEnvironmentIDE'></a>Integrated Development Environment (IDE)
...
## 3. <a name='ExecutionEnvironment'></a>Execution Environment
...
## 4. <a name='PackageManager'></a>Package Manager
...
## 5. <a name='ProgrammingLanguage'></a>Programming Language
...
## 7. <a name='CodeFormatting'></a>Code Formatting
...
## 8. <a name='Committing'></a>Committing
...
[lint-staged](https://www.npmjs.com/package/lint-staged), was installed to
filter out files that are not staged. `lint-staged` can run commands in
...
most use cases, without configuration or plugins: TypeScript, CSS, images,
fonts. It can transpile TypeScript to JavaScript, without reliance on
Microsoft's `tsc`. It's own compiler is much faster, because it doesn't do type
checking. A dev server is also included.

## 10. <a name='StateManagement'></a>State Management
...
introduced the Flux architecture. A reliable implementation of Flux is
[Redux](https://redux.js.org/) which is used in this template. Redux has
recently been enhanced with a [toolkit](https://redux-toolkit.js.org/) that
...
## 11. <a name='TODO:FetchingData'></a>TODO: Fetching Data
...
## 12. <a name='TODO:Routing'></a>TODO: Routing
...
## 13. <a name='GraphicalUserInterface'></a>Graphical User Interface
...
rendering, which simplifies the web server configuration, because only static
files must be served.
