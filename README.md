...
therefore, [Parcel](https://parceljs.org/) bundler is used. Parcel's is designed
to be "Zero Config" providing sensible defaults out of the box. It can handle
most use cases, without a configuration or plugins: TypeScript, CSS, 
...
## State Management
Scalable React application requires managing state between components.
Architecture for maintainable application state management was proposed by 
...
of slices that further standardizes state management.

A Redux store has already been set up in the template. Furthermore a typed
...
then storing it in state repetitive and lacks creativity. This template
prioritizes creative business logic programming over boilerplate. To reduce 
boilerplate [RTK Query] is used. It is part of the Redux Toolkit and 
standardizes fetching and caching.

## Routing
Scalable applications have multiple views. A routing mechanism is required to
swtich between them. The most popular routing library for React was chosen:
...
Creating a consistent design system  and based in it, a library of accessible 
GUI components, is a complex project by itself. The focus if this template is 
application development,not component design. Therefore, a third party component
library is used.

Adobe's
[React Spectrum](https://react-spectrum.adobe.com/react-spectrum/index.html)
component library was chosen for several reasons. Spectrum components are:
